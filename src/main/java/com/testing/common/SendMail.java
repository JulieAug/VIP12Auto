...
public class SendMail {
	...
	public String myEmailAccount = "1678255738@qq.com";
	public String myEmailPassword = "lpynxeyqlkwdfcie";
	...
	// 抄送名单
	public String copyMailAccount = "1678255738@qq.com";
	// 标题
	public String title = "造物自动化测试邮件结果";
	// 属性
